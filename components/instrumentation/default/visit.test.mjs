...
assertEqual(
  ...
  normalize(
    `eval(
      EVAL(
        "protocol://host/script.js/eval-1",
        123,
      ),
      456,
    );`,
...
//           APPLY_BUNDLE_TAB,
//           ${stringifyJSON(
//             stringifyLocation(makeLocation("protocol://host/script.js", 1, 1)),
//           )},
//           APPLY.empty,
//           [APPLY_ARGUMENT_0, APPLY_ARGUMENT_1, APPLY_ARGUMENT_2],
//         );
...
//           APPLY_BUNDLE_TAB,
//           ${stringifyJSON(
//             stringifyLocation(makeLocation("protocol://host/script.js", 1, 0)),
//           )},
//           this,
//           []
//         )
...
//             APPLY_BUNDLE_TAB,
//             ${stringifyJSON(
//               stringifyLocation(makeLocation("protocol://host/script.js", 2, 0)),
//             )},
//             APPLY.empty,
//             [],
//           )
