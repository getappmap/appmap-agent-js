...
export default (dependencies) => {
  ...
  return {
    ...
    getQualifiedName: (counter, lineage) => {
      if (isClassBound(lineage) || isObjectBound(lineage)) {
        return {bound:true, name:getKeyName(lineage.tail.head)};
      }
      return {bound:false, name:getEnvironmentName(counter, lineage)};
    },
    getCompleteName: (counter, lineage) => {
