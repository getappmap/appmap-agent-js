...
exports.make = (name) => ({
  ...
  metadata: {
    ...
    app:
      "Optional >> name of the app to assign to the scenario. The organization to which the app belongs may be specified by separating the organization name and app name by a forward slash /. If no organization name is specified, the data is loaded into the user's personal data set. Example of a scoped name: myorg/myapp. Example of an unscoped name: myapp. The forward-slash character is illegal in app names and org names.",
    feature:
    ...
    recorder: {
      name:
        'Required name of the recording method. This name must be unique to the client, but need not be unique across different clients.',
    },
    recording: {
      defined_class:
