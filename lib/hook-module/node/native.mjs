...
export default (dependencies) => {
  ...
  const transformSourceDefault = (content, context, transformSource) =>
    transformSource(content, context, transformSource);
  return {
    transformSourceDefault,
    unhookNativeModule: (box) => {
      setBox(box, transformSourceDefault);
    },
    hookNativeModule: (client, frontend, { hooks: { esm } }, box) => {
      if (esm) {
