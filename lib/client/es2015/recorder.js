...
const makeRequestSync = (action) => function requestSync () {
...
const makeRequest = (action) => function request () {
...
exports.start = (channel, session, configuration) => new global_Promise((resolve, reject) => {
  channel.request({
    action: "start",
    session,
    configuration
