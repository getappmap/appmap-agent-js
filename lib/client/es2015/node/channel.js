...
module.exports = (env) => {
  ...
  if (typeof env.APPMAP_PROTOCOL !== "string") {
    return env.APPMAP_PROTOCOL;
  ...
  if (env.APPMAP_PROTOCOL in protocols) {
    return {
      requestSync: require(`./request/sync/${env.APPMAP_PROTOCOL}.js`)(
        env.APPMAP_HOST,
        env.APPMAP_PORT
      ),
      requestAsync: require(`./request/async/${env.APPMAP_PROTOCOL}.js`)(
        env.APPMAP_HOST,
        env.APPMAP_PORT
      ),
    };
  ...
  throw new global_Error(
    `Invalid APPMAP_PROTOCOL environment variable, got: ${env.APPMAP_PROTOCOL}`
  );
};
