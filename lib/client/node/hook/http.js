  ...
  };
  {
    const hook = (request) => {
      ...
      request.on("finish", () => {
        ...
        couple.recordCall("http_client_request", {
      ...
      request.on("response", (response) => {
        response.on("end", () => {
          couple.recordReturn("http_client_response", {
    ...
    const hook = (server) => {
      server.on("request", (request, response) => {
        ...
        response.on("finish", () => {
          ...
          couple.recordCall("http_server_request", {
            request_method: request.method,
          ...
          couple.recordReturn("http_server_response", {
            status_code: response.statusCode,
            status_message: response.statusMessage,
