  ...
  };
  {
    const hook = (request) => {
      ...
      request.on("finish", () => {
        ...
        recordReturn = recordCall("http_client_request", {
      ...
      request.on("response", (response) => {
        response.on("end", () => {
          recordReturn("http_client_response", {
  ...
  }
  {
    const hook = (server) => {
      server.on("request", (request, response) => {
        const recordReturn = recordCall("http_server_request", {
          request_method: request.method,
        ...
        response.on("finish", () => {
          recordReturn("http_server_response", {
            status_code: response.statusCode,
            status_message: response.statusMessage,
