...
if (
  Reflect.getOwnPropertyDescriptor(process.env, "APPMAP_LOG_LEVEL") !== undefined
) {
  ...
  logger.info(`No APPMAP_LOG_LEVEL environment variable provided, defaulting to WARNING`);
}
