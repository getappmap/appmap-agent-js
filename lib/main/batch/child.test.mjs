...
const testAsync = async () => {
      ...
      { options: { env, ...options }, ...child },
      {
        options: {
          env: {
            key2: "value2",
            key1: "value1",
            NODE_OPTIONS: `node-options --experimental-loader=${prefix}/loader.mjs --experimental-loader=${prefix}/process-tcp.mjs`,
          },
          encoding: "utf8",
          cwd: "/directory2",
          stdio: "inherit",
  ...
  // spawn mocha //
  {
    ...
    assertDeepEqual(
      ...
      {
        exec: "mocha",
        argv: ["--require", `${prefix}/mocha-tcp.mjs`, "argv0"],
      },
    );
  }
  // spawn npx mocha //
  {
    ...
    assertDeepEqual(
      ...
      {
        exec: "npx",
        argv: ["mocha", "--require", `${prefix}/mocha-tcp.mjs`, "argv0"],
      },
    );
  }
  // fork //
