...

{
  ...
  assignVisitorObject('SuperableExpression', { TemplateLiteral: visitor });
  assignVisitorObject('SpreadableExpression', { TemplateLiteral: visitor });
  assignVisitorObject('DeclarableExpression', { TemplateLiteral: visitor });
}

{
  ...
  assignVisitorObject('DeclarableExpression', visitors);
