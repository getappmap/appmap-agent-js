...
assignVisitorObject("TemplateLiteral", {
  TemplateLiteral: (node, location) => combineResult(
    makeTemplateLiteral,
    node,
...
assignVisitorObject("Expression", {
  ...
  TemplateLiteral: getVisitorObject("TemplateLiteral").TemplateLiteral,
  ...
  // ObjectExpression cf visit-object.mjs
  // ArrowFunctionExpression cf visit-closure.mjs
  // FunctionExpression cf visit-closure.mjs
  ...
  Identifier: getVisitorObject("ScopingIdentifier").Identifier,
...
assignVisitorObject("ChainElement", {
  CallExpression: getVisitorObject("Expression").CallExpression,
  MemberExpression: getVisitorObject("Expression").MemberExpression
});
