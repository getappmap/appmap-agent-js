...
import {assignVisitorObject, visitNonScopingIdentifier, visitTemplateElement, visitTemplateLiteral, visitSpreadableExpression, visitPattern, visitExpression} from "./visit.mjs";
...

{
  ...
  const makeTaggedTemplateExpression = (node, child1, child2) => ({
