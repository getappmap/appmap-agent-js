...
const makeDummyStringLiteral = (kind, node, location) => ({
  type: 'Literal',
...
const mapping = {
  ...
  Source: {
    visitors: { __proto__: null },
    dummify: makeDummyStringLiteral,
  },
  Statement: {
    visitors: { __proto__: null },
...
export const visitStringLiteral = makeVisit('StringLiteral');
