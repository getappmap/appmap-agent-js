...

{
  ...
  assignVisitorObject('SpreadableExpression', { Literal: visitor });
  assignVisitorObject('SuperableExpression', { Literal: visitor });
  assignVisitorObject('DeclarableExpression', { Literal: visitor });
}
...

{
  ...
  }
  {
    ...
    assignVisitorObject('SpreadableExpression', { Identifier: visitor });
    assignVisitorObject('SuperableExpression', { Identifier: visitor });
    assignVisitorObject('DeclarableExpression', { Literal: visitor });
