...
export default (dependencies) => {
  ...
  return {
    ...
    configureRecording: ({ serialization }, configuration) =>
      configureSerialization(serialization, configuration),
    // configure: compose(generateGet("serialization"), configureSerialization),
