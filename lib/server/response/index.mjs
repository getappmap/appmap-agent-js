...
import { makeServer as makeHttp3Server } from './http2.mjs';
...
module.exports = (protocol, dispatcher, options) => {
  if (!(protocol in makers)) {
    logger.error(`Invalid protocol defaulting to 'messaging' and got: %s`, protocol);
    protocol = "messaging";
  }
