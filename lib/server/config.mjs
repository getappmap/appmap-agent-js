...
const mappings = {
  "env": {
    ...
    APPMAP_LANGUAGE_VERSION: {
      ...
      sanitize: makeLanguageVersionSanitizer("APPMAP_LANGUAGE_VERSION env argument")
    },
  ...
  "json": {
    ...
    "language-version": {
      name: "language_version",
      sanitize: makeTypeSanitizer("string", "language-version value", DEFAULT_LANGUAGE_VERSION)
    },
    "escape-prefix": {
      name: "escape_prefix",
      sanitize: combine(
        makeTypeSanitizer("string", "escape-prefix value", DEFAULT_ESCAPE_PREFIX),
        makeEscapePrefixSanitizer("escape-prefix value")
      )
    },
    "output-dir": {
      name: "output_dir",
      sanitize: makeTypeSanitizer("string", "output_dir value", DEFAULT_OUTPUT_DIR)
    },
    "packages": {
      name: "packages",
      sanitize: combine(
        makeArraySanitizer(
          "output_dir conf value",
          (json, index) => {
...
class Config {
  ...
  extendWithEnv (env) {
    return extendWithEnv(this.conf, env);
  }
  getEscapePrefix () {
  ...
  getLanguageVersion () {
    return this.conf.languate_version;
  }
  getMapName () {
