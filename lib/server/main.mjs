...
export const main = (cwd, writable, options) =>
  getInitialConfiguration()
    .extendWithData({
      cwd,
      extends: 'appmap.yml',
      children: extractChilderen(options),
        ...
        new Promise((resolve, reject) => {
          ...
          const step = () => {
            if (index === children.length) {
              ...
              const id = index;
              index += 1;
              writable.write(`#${id}: ${children[id].description} ...\n`);
              configuration
                .spawnChild(children[id])
