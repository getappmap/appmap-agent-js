  ...
  },
  {
    ...
    properties: {
      ...
      output: {
        type: "object",
        additionalProperties: false,
        required: ["directory", "filename", "postfix", "indent"],
        properties: {
          directory: {
            $ref: "absolute-path",
          },
            ...
            anyOf: [
              {
                ...
                properties: {
                  ...
                  data: {
                    type: "object",
                    additionalProperties: false,
                    required: ["group", "origin", "description"],
                    properties: {
                      group: {
                        $ref: "index",
                      },
                    ...
                    anyOf: [
                      {
                        type: "object",
                        additionalProperties: false,
                        required: ["type", "index", "configuration"],
                        properties: {
                          type: {
                            const: "start",
                          },
              ...
              },
              {
                ...
                properties: {
                  ...
                  data: {
                    type: "object",
                    additionalProperties: false,
                    required: ["type", "time", "group", "index", "data"],
                    properties: {
                      type: {
                        enum: ["before", "after"],
                      },
